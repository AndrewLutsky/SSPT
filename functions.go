...
func ChouFasman(protein Protein, parameters [][]float64, aaIndexMap map[rune]int) PredArray {
	...
	// 0: not determined, 1: helix, 2: sheet, 3: loop
...
//Functions for reading in files (parameters, and different file formats).
...
// This functtion takes in the inputs from the GorParams folder and writes it out to a
// 2D array.
